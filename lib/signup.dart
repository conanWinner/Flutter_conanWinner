          ...
          child: ListView(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Text(
                          "Sign Up", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold), textAlign: TextAlign.left
                      ),
                    ),

                    Text(
                        "Enter your credentials to continue", style: TextStyle(fontSize: 13, color: Colors.blueGrey), textAlign: TextAlign.left
                    ),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: TextField(
                  controller: _emailController,
                  decoration: InputDecoration(labelText: "Email", errorText: _emailInvalid ? _emailErrorr: null),
                ),
              ),
              Padding(
                ...
                child: Stack(
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(labelText: "Password", errorText: _passInvalid ? _passwordErrorr: null, errorMaxLines: 2),
              ...
              Padding(
                ...
                child: Text("By continuing you agree to our Terms of Service and Privacy Policy.", style: TextStyle(fontSize: 13, color: Color(0xff888888)), textAlign: TextAlign.left,),
              ),

              SizedBox(
                height: 56,
                width: double.infinity,
                child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF53B175)), onPressed: buttonSignup, child: Text("SIGN IN", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),),
              ),
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Already have an account? ", style: TextStyle(fontSize: 12, color: Color(0xff888888), fontWeight: FontWeight.bold),),
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MyApp()));
                      },
                      child:
                      Text("Sign in", style: TextStyle(fontSize: 12, color: Color(0xFF53B175), fontWeight: FontWeight.bold),),
                    )
                  ],
                ),
              ),
